...
Aurhor: Anurup Borah (anurupborah2001@gmail.com)
*/
    ...
    try {
        ...
        this.run = function () {
            if (!isEmpty(paramsObj)) {
                ...
                var cdp_params = {
                    uid: get_cookie_value("suid") || "00000000000000000000000000000000",
                ...
                jQuery.error('Initialization error');
            }
        };
    } catch (e) {
        jQuery.error("Error occurred when calling cdp");
    }
}

var SPH_CDP = function () {
    // wrapper around the `new` syntax
    return new SPH_CDPWrap();
};
